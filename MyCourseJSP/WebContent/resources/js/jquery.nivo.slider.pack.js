...
if(vars.currentImage.attr('title')!=''){var title=vars.currentImage.attr('title');if(title.substr(0,1)=='#')title=$(title).html();if($('.nivo-caption',slider).css('display')=='block'){$('.nivo-caption',slider).animate({top:'500'},400,'easeInBack').fadeOut(settings.animSpeed,function(){$(this).html(title);$(this).animate({top:'-500'},0).animate({top:'0'},400,'easeOutBack').fadeIn(settings.animSpeed);});}else{$('.nivo-caption',slider).html(title);}
